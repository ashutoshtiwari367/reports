...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php if (isSuperAdmin()): ?>
            <a href="/shops/index.php" class="nav-item <?= $currentPage==='index'&&strpos($_SERVER['REQUEST_URI'],'shops')!==false?'active':'' ?>">
                <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                Shops
            </a>
            <a href="/users/index.php" class="nav-item <?= strpos($_SERVER['REQUEST_URI'],'users')!==false?'active':'' ?>">
            ...
            <a href="/loans/index.php" class="nav-item <?= strpos($_SERVER['REQUEST_URI'],'loans')!==false?'active':'' ?>">
                <svg viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                Loans / Sales
            </a>
            <a href="/reports/today_due.php" class="nav-item <?= $currentPage==='today_due'?'active':'' ?>">
            ...
            <a href="/reports/index.php" class="nav-item <?= strpos($_SERVER['REQUEST_URI'],'reports')!==false?'active':'' ?>">
            ...
            <a href="/exports/export_excel.php" class="nav-item">
    ...
    <div class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-right">
                <span class="topbar-date"><?= formatDate(date('Y-m-d')) ?></span>
            </div>
        </header>
